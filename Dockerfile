...
RUN git clone https://github.com/comfyui-beautyai.git /comfyui/custom_nodes/comfyui-beautyai
...
RUN comfy model download --url https://huggingface.co/Phr00t/Qwen-Image-Edit-Rapid-AIO/blob/main/v20/Qwen-Rapid-AIO-NSFW-v20.safetensors --relative-path models/checkpoints --filename Qwen-Rapid-AIO-NSFW-v20.safetensors
